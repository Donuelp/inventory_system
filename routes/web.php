...
Route::group(['middleware' => 'auth'], function () {
    //User management
    Route::get('/manage-users', 'UserManagementController@index')->name('users.view');
    Route::post('user/hard_delete', 'UserController@destroyAJAX')->name('user.destroyAJAX');
    Route::get('user/get_user/{id}', 'UserController@getUser');
    //End User management

    //Masterfile 

        //Branch routes
        Route::post('branches/destroyAJAX', 'BranchesController@destroyAJAX')->name('branches.destroyAJAX');
        Route::post('branches/updateAJAX', 'BranchesController@updateAJAX')->name('branches.updateAJAX');
        Route::resource('branches', 'BranchesController');
        //End Branch routes
        
        //Category routes   
        Route::post('categories/updateAJAX', 'CategoriesController@updateAJAX')->name('categories.updateAJAX');     
        Route::resource('categories', 'CategoriesController', ['except' => ['update, destory']]);
        //End category routes

        //Item routes
        Route::post('items/updateAJAX', 'ItemController@updateAJAX')->name('items.updateAJAX');
        Route::resource('items', 'ItemController', ['except' => ['show', 'update', 'destroy', 'create']]);
        //End item routes

        //Measurement routes
        Route::post('measurement/updateAJAX', 'MeasurementController@updateAJAX')->name('measurement.updateAJAX');
        Route::resource('measurement', 'MeasurementController', ['except' => ['show', 'update', 'destory', 'create']]);
        //End measurement rotues
