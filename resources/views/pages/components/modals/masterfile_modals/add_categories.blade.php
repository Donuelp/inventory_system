<div class="modal fade modal-info" id="category_modal" tabindex="-1" role="dialog" aria-labelledby="category_modal" aria-hidden="true">
        ...
        <div id="category_body">
          <div class="modal-body">
              <fieldset id="modal_field">
                 <form class="form" method="POST" enctype="multipart/form-data" id="category_form">
                  @csrf
                    ...
                    <div class="card-content">
                        <div class="input-group no-border form-control-lg">
                            ...
                            <input type="text" name="category_name" id="category_name" class="form-control" required="" autocomplete="off" placeholder="Category Name">
                        </div>
                       <div class="input-group no-border form-control-lg">
                          <div class="input-group-prepend">
                              <div class="input-group-text">
                          ...
                          <textarea placeholder="Category Description" id="category_desc" name="category_desc" class="form-control"></textarea>
                       </div>
                    </div>
                 </form>
              </fieldset>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                      <div id="add_button_holder">
                        <button id="add_category_button" class="btn btn-simple btn-neutral d-block" style="width: 100%;" onclick="createCategory()">Add Category</button> 
                      </div>
