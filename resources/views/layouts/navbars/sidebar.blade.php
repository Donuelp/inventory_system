...
-->
  <div class="sidebar-wrapper">
    ...
    <ul class="nav">
      ...
      {{-- Start masterfile --}}
      <li class="{{ $menuParent == 'Inventory' ? 'active' : '' }}">
        <a data-toggle="collapse" href="#tablesExamples" {{ $menuParent == 'Inventory' ? 'aria-expanded="true"' : '' }}>
        ...
        <div class="collapse {{ $menuParent == 'items' ? 'show' : '' }}" id="tablesExamples">
          <ul class="nav">
            <li class="{{ $activePage == 'regular' ? ' active' : '' }}">
              <a href="{{ route('items.index') }}">
                <span class="sidebar-mini-icon">IT</span>
                <span class="sidebar-normal"> {{ __('Items') }} </span>
              </a>
            </li>
            <li class="{{ $activePage == 'regular' ? ' active' : 'categories' }}">
...
{{--             <li class="{{ $activePage == 'regular' ? ' active' : '' }}">
              <a href="{{ route('page.regular_tables') }}">
                ...
                <span class="sidebar-normal"> {{ __('Location') }} </span>
              </a>
            </li> --}}
            <li class="{{ $activePage == 'branches' ? ' active' : 'branches' }}">
              <a href="{{ route('branches.index') }}">
                <span class="sidebar-mini-icon">BR</span>
                <span class="sidebar-normal"> {{ __('Branches') }} </span>
              </a>
            </li>
            <li class="{{ $activePage == 'unit_measurement' ? ' active' : 'unit_measurement' }}">
              <a href="{{ route('measurement.index') }}">
                <span class="sidebar-mini-icon">UM</span>
                <span class="sidebar-normal"> {{ __('Unit Measure') }} </span>
              </a>
            </li>
            <li class="{{ $activePage == 'regular' ? ' active' : '' }}">
              <a href="{{ route('page.regular_tables') }}">
